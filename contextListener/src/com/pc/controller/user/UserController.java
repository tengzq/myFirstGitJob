...
import com.pc.service.GroupService;
...
import com.pc.util.FileDownload;
import com.pc.util.FileUpload;
import com.pc.util.GetPinyin;
import com.pc.util.ObjectExcelRead;
import com.pc.util.ObjectExcelView;
import com.pc.util.PageData;
import com.pc.util.PathUtil;
...
public class UserController extends BaseController {
	...
	public ModelAndView goEditU( HttpServletResponse res) throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		...
		List<PageData> groupList = groupService.listAll(null);
	...
	public ModelAndView goAddU()throws Exception{
		...
		pd = this.getPageData();
		List<Role> roleList;
		List<PageData> groupList;
		roleList = roleService.listAllERRoles();			//列出所有二级角色
		groupList = groupService.listAll(null);
		mv.setViewName("system/user/user_edit");
