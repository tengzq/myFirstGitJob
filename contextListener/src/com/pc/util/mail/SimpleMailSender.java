  ...
  */    
    ...
    public static void sendEmail(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE, String CONTENT, String TYPE) throws Exception{ 
	    ...
	    if("1".equals(TYPE)){
	    	...
	    	boolean isOk = sms.sendHtmlMail(mailInfo);
	    	if(isOk){
	    		System.out.println(SimpleMailSender.class + "邮件发送成功");
	    	}
	    }
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("tkintc@163.com");    
	     mailInfo.setPassword("2241162aa");//您的邮箱密码    
	     mailInfo.setFromAddress("tkintc@163.com");    
	     mailInfo.setToAddress("omg88888888@163.com");    
	     mailInfo.setSubject("you are my sunshine");    
	     mailInfo.setContent("you are my sunshine");    
	     //这个类主要来发送邮件   
