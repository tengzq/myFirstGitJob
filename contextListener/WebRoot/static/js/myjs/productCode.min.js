...
function saveD() {
	...
	var dtype = $("#dtype").val();
	var dbz = $("#dbz").val();
	var isQian = $("#isQian").val();
	var ddefault = $("#ddefault").val();
	...
	var fields = dname + ",fh," + dtype + ",fh," + dbz + ",fh," + isQian
			+ ",fh," + ddefault;
	if (msgIndex == "") {
		arrayField(fields)
	} else {
	...
	$("#fields")
			.append(
					"<tr>" + '<td class="center">'
							...
							+ value
							+ '">'
							+ '<a class="btn btn-mini btn-info" title="编辑" onclick="editField(\''
							+ value
							+ "','"
							+ index
							+ '\')"><i class="icon-edit"></i></a>&nbsp;'
							+ '<a class="btn btn-mini btn-danger" title="删除" onclick="removeField(\''
