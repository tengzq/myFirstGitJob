...
<link href="wj-mobile-static/css/reg.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="wj-mobile-static/js/register.js"></script>
...
<div class="mainbody">
    <div class="reg">
        ...
        <ol>
            ...
            <li>
            	<p class="fl"><input type="text" placeholder="请输入图片验证码" id="imgVerfiyCode"><i class="fa fa-recycle"></i></p>
                <p class="fr"><img alt="点击刷新" src="" id="codeImg" style="margin-top: 7px;"></p>
                <div class="clear"></div>
            </li>
            <li>
