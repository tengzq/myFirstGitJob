...
<html>
	...
	<head>
		...
		<style>
			html,body {margin:0;width: 100%;height: 100%;background: #E7BC61 url(wj-mobile-static/ui2/images/sharebg_v2.png) no-repeat center center /100%  auto ;font-family: "微软雅黑",verdana,sans-serif;font-size: 16px;}
	...
	<body>
		...
		<div>
			...
			<%-- <h3>我要</h3>
			<a href="mobile/register?INVITE_ME=${INVITE_ME}">万金生活</a> --%>
			<a href="mobile/register?INVITE_ME=${INVITE_ME}">
				<!-- <img src="wj-mobile-static/images/click-reg.png" alt="点击注册" style="width:180px;"/> -->
				<input type="button" value="点击注册"/>
				<p class="kq">开启·万金生活</p>
			</a>
		</div>
