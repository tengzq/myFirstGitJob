...
<link rel="stylesheet" href="wj-mobile-static/ui2/css/calendar.css"/>

<script src="wj-mobile-static/js/jquery-1.9.1.min.js" type="text/javascript"></script>
<script type="text/javascript" src="wj-mobile-static/ui2/js/calendar.js"></script>
...
<!-- <img src="wj-mobile-static/ui2/images/yu.png"> -->
	<div class="face">
		<div class="user lanzi">
			...
			<p><span class="dayName"></span></p>
			<p class="cur-day-repay">0.00</p>
			<p>应收本息（元）</p>
	   	</div>
    </div>
</div>
	...
	<div class="my-calendar clearfix">
		...
		<div id="calendar" class="calendar">
			<div class="cal-header clearfix">
				<a title="上月" class="prev disabled"><i class="fa fa-angle-left"></i></a>
				<div class="jump-today" title="回到今天"><span class="year">2015年</span><span class="month">5月</span></div>
				<a title="下月" class="next disabled"><i class="fa fa-angle-right"></i></a>
			</div>
			<div class="cal-days">
		...
		<div id="payBackCal" class="payBackCal" style="display: none;">
