...
<script src="wj-mobile-static/js/authrn.js" type="text/javascript"></script>



</head>

<body style="background:#eb6161">
...
<div class="mainbody">
    <div class="reg">
        ...
        <ol style="margin-bottom: 60%;">
        	<li><p><input type="text" id="realname" placeholder="真实姓名"><i class="fa fa-user"></i></p></li>
        	<li><p><input type="text" id="idno" placeholder="身份证号"><i class="fa fa-key"></i><i class="fa fa-eye"></i></p></li>
            <div class="clear"></div>
            <li>
            	<p>
            		<input type="button" id="subbtn" value="实名认证">
            		<input type="button" id="fakeBtn" value="正在提交" style="background: #909090;display: none">
                </p>
            </li>
        ...
        <!-- <div class="footer">
			<p>©万金先生 京ICP备15033688号</p>
   			 <p><a href="mobile/main">手机版</a><a href="www.wanjinxiansheng.com">PC版</a><span>4008-337-520</span></p>
		</div> -->
