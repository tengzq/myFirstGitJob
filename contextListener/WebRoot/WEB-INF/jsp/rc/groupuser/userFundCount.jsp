...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="groupUser/groupUserFundsList.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
					...
					<td><input class="span10 date-picker" name="queryMonth" id="queryMonth" value="${pd.queryMonth}" type="text" data-date-format="yyyy-mm" readonly="readonly" style="width:88px;" placeholder="月份"/></td>
					<td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>buy/excel.do?searchTxt='+$('#nav-search-input').val()+'&dateStart='+$('#dateStart').val()+'&dateEnd='+$('#dateEnd').val();
		}
		</script>
