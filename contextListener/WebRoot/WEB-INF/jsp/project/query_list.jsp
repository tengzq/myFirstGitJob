...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
						...
						<c:forEach items="${list}" var="var" varStatus="vs">
							...
							<%-- 			<td  class="moneyStyle">${var.BOSS_INTEREST_RATE}%</td> --%>
									...
									<%-- 	<td>${var.TOTAL_PHASE}</td>
										...
										<<td>
											<input type="button" class="btn btn-warning btn-mini" value="确认" onclick="querybabab('${var.id}')"/>
										</td> 
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function viewBuyerRecord(Id){
			window.location.href='<%=basePath%>_project/goBuyerRecord.do?PROJECT_ID='+projectId;
		}
		
		function querybabab(Id){
			window.location.href='<%=basePath%>_project/quQueryTouzhi.do?ID='+Id;
		}
		function man(a){
