...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="publish/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
							...
							<%-- 			<td  class="moneyStyle">${var.BOSS_INTEREST_RATE}%</td> --%>
									...
									<%-- 	<td>${var.TOTAL_PHASE}</td> --%>
										...
										<c:if test="${var.IS_PUBLISH==2}">
											<input id="publish_${var.ID}" type="button" class="btn btn-warning btn-mini" value="发布" onclick="changeIsPublish('${var.ID}',1)"/>
										</c:if>
