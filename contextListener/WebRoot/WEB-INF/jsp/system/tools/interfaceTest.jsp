  ...
  <div class="row-fluid">
					...
					<div class="step-content row-fluid position-relative">
						<div style="float: left;">
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址" value="http://127.0.0.1:8080/FHMYSQL/appuser/getAppuserByUm.do?USERNAME=dsfsd" style="width:540px;">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function sendSever(){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>tool/severTest.do',
