                    	...
                    	<div class="tzjl">
                        	<nav>
                                <ul>
                                    ...
                                    <c:if test="${sessionScope.sessionZfBuUser.memberClassType == 0}">
                                    <li class="7"><a href="<%=basePath %>fundsflow/fundsList?type=7">还款</a></li>
                                    <li class="8"><a href="<%=basePath %>fundsflow/fundsList?type=8">收款</a></li>
                                    </c:if>
                                </ul>
                            </nav>
