...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="yytraffic/userBuyRecord.do?userId=${pd.userId}" method="post" name="Form" id="Form">
			<table>
				<%-- <tr>
					<td>
						...
						<c:forEach items="${recordList}" var="var" varStatus="vs">
							<tr>
								<td class='center' style="width: 30px;">
									<label><input type='checkbox' name='ids' value="${var.record_id}" /><span class="lbl"></span></label>
								</td>
