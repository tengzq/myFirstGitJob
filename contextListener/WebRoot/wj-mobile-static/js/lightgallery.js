...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.isVideo = function(src, index) {
        ...
        try{console.log('src : '+src)}catch(e){}
    ...
    Plugin.prototype.loadContent = function(index, rec, delay) {
        ...
        var getResponsiveSrc = function(srcItms) {
        	try{console.log('srcItms : ' +srcItms)}catch(e){}
            var rsWidth = [];
            var rsSrc = [];
        ...
        try{console.log('_this.s.dy = ' + _this.s.dynamic)}catch(e){}
        if (_this.s.dynamic) {
            ...
            try{console.log('_src = ' + _src)}catch(e){}
