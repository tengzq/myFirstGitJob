...
<!-- saved from url=(0040)https://lantouzi.com/user/trade/datalist -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432020644000};
		...
		<div id="bd">
			<div class="content clearfix">
				<div class="main alignright">
					<div class="my-page my-page-trade">
	<div class="my-mod my-flows">
		<div class="hd">
			<h2>资金流水</h2>
		</div>
		<div class="bd">
			<div class="flows-types my-tabs clearfix">
				<a href="../../jingtai/css/懒投资 - 专为懒人打造的优质理财平台.htm" class="on">全部</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=1">充值</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=2">提现</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=3">投资</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=4">收益</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=5">回收本金</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=6">平台奖励</a>
									<a href="https://lantouzi.com/user/trade/datalist?type=7">其他</a>
							</div>

			<div class="flows-table" style="clear: left;">
				<table class="table">
					<tbody><tr>
						<th>类型</th>
						<th>交易时间</th>
...
$(function(){
	...
	pager.onclick = function(index){
		...
		var url = "https:\/\/lantouzi.com\/user\/trade\/datalist" + '?' + $.param(ps);
		location.href = url;
	}
	pager.render();
});
	...
	<div class="my-nav">
		<ul class="my-nav-1stlevel-list">
			...
			<a href="<%=basePath%>jsps/user/funds_flow.jsp">零钱计划<i>Beta</i></a>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/user/trade/datalist?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/user/trade/datalist?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
