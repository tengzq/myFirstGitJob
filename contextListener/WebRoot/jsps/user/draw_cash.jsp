...
<!-- saved from url=(0034)https://lantouzi.com/user/withdraw -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432021046000};
...
<script type="text/javascript" src="jingtai/css/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="jingtai/css/ltz.common.js"></script>
<script type="text/javascript" src="jingtai/css/seed.min.js"></script>
		...
		<div id="bd">
			<div class="content clearfix">
				<div class="main alignright">
					<style>
	.ll-notice {width:600px;margin-top:50px;}
...
<div class="my-page my-page-withdraw">
	<div class="my-mod my-withdraw">
		...
		<div class="bd">
					...
					！还未绑定提现银行卡，<a href="https://lantouzi.com/user/account/bindcard">立即绑定</a>才能提现
				</div>
						<div class="ll-notice">
...
<script type="text/tmpl" id="dialog-tmpl">
	<div class="dg_wrapper dialog-tixian">
		<div class="hd">
			<h3>提现</h3>
		</div>
		<div class="bd">
			<p>请在新打开的页面完成提现后选择：</p>
			<div class="ret">
				<p>提现成功：<a href="https://lantouzi.com/user/withdraw/datalist" class="btn btn-4">确认成功</a></p>
				<p>提现失败：<a href="#" class="btn btn-3 close-btn tongji" data-category="重新提现" data-label="withdraw">重新提现</a>&nbsp;&nbsp;<span class="help">查看&nbsp;<a href="https://lantouzi.com/about/help" class="highlight tongji" target="_blank" data-category="查看帮助" data-label="withdraw">帮助中心</a></span></p>
			</div>
		</div>
...
$(document).ready(function(){
	...
	function ckAmount(){
		...
		if (!$.trim(amountVal)) { 
			$amountValidEm.showValid();
			return true;
		}
		if(!/^\d+(\.\d{1,2})?$/.test(amountVal)){
			$amountValidEm.showValid(false, '金额格式错误！');
			return false;
		}
		var amount = parseFloat(amountVal) * 100;
		if(amount < WITHDRAW_MIN * 100){
			$amountValidEm.showValid(false, '最小提现金额为' + WITHDRAW_MIN + '元');
			return false;
		}else if(amount > WITHDRAW_MAX * 100){
			$amountValidEm.showValid(false, '您最大可提现金额为' + WITHDRAW_MAX + '元');
			return false;
		}
		$amountValidEm.showValid(true);
		return true;
	}
	$amount.on('keyup', function(){
		if(ckAmount()){
			$retMount.text(numberFormat(Math.floor(nowAmount + parseFloat($amount.val()) * 100)/100, 2));
		}
	...
	$('#withdraw-form').on('submit', function(e){
		if(!$amount.val()){
			$amountValidEm.showValid(false, '请输入提现金额');
			e.preventDefault();
			return;
		}
		if(!ckAmount()){
		...
		$(document).trigger('submit2yeepay');
	});
	...
	<div class="my-nav">
		<ul class="my-nav-1stlevel-list">
			<li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user">账户概览</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/order/datalist">投资记录</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/lingqianjihua">零钱计划<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/trade/datalist">资金流水</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/recharge">我要充值</a></h3></li><li class="my-nav-1stlevel on"><h3><a href="jingtai/css/懒投资 - 专为懒人打造的优质理财平台.htm">我要提现</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/account/bindcard">提现银行卡</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/autobid">自动投标</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/coupon?type=1">投资券</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/tiyanjin">体验金<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/account">个人信息</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/invite">邀请有奖</a></h3></li>		</ul>
	</div>
</div>
			</div>			
		</div>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/user/withdraw?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/user/withdraw?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
