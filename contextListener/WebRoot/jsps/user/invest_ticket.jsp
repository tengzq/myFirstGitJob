...
<!-- saved from url=(0039)https://lantouzi.com/user/coupon?type=1 -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432021105000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
		...
		<div id="bd">
			<div class="content clearfix">
				<div class="main alignright">
					<div class="my-page my-page-ticket">
	<div class="my-mod my-ticket">
		<div class="hd">
			<h2>投资券</h2>
			<div class="clearfix" style="position:absolute;top:20px;right:0px;width:130px;background:#fff">
				<a href="https://lantouzi.com/user/couponcard" class="btn alignright" style="border-radius: 5px;text-indent:0;width: 107px;background: #fff;color: #f66;border: 1px solid #f66;letter-spacing:0;">兑换投资券</a>
			</div>
		</div>		
		<div class="bd">
			<div class="my-tabs clearfix">
									<a href="../../jingtai/css/懒投资 - 专为懒人打造的优质理财平台.htm" class="on">满减券</a>
									<a href="https://lantouzi.com/user/coupon?type=2">加息券</a>
							</div>
			<ul class="clearfix ticket-lists">
												<li class="ticket clearfix">
					<div class="ticket-card alignleft">
						<h4>满额抵扣券</h4>
						<p class="ticket-amount">
							<em class="highlight">
												...
												<div class="ticket-status ticket-status-new">可用</div>
					</div>
					<div class="ticket-data alignleft">
						<p class="ticket-title">10000-50投资券</p>
						<p>使用规则：投资单笔1万元及以上立减50元，懒人计划1月期及以下不可使用此券。</p>
						<p>有效期限：2015-05-18 09:09:12 至 2015-07-17 09:09:12</p>
													<a href="https://lantouzi.com/project" class="btn btn-3">投资使用</a>
											</div>
				</li>
												<li class="ticket clearfix">
					<div class="ticket-card alignleft">
					...
					<div class="ticket-data alignleft">
						<p class="ticket-title">50000-230投资券</p>
						<p>使用规则：投资单笔5万元及以上立减230元，懒人计划1月期不可使用此券。</p>
						<p>有效期限：2015-05-18 09:09:12 至 2015-07-17 09:09:12</p>
													<a href="https://lantouzi.com/project" class="btn btn-3">投资使用</a>
											</div>
				</li>
	...
	<div class="my-nav">
		<ul class="my-nav-1stlevel-list">
			<li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user">账户概览</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/order/datalist">投资记录</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/lingqianjihua">零钱计划<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/trade/datalist">资金流水</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/recharge">我要充值</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/withdraw">我要提现</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/account/bindcard">提现银行卡</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/autobid">自动投标</a></h3></li><li class="my-nav-1stlevel"><h3><a href="../../jingtai/css/懒投资 - 专为懒人打造的优质理财平台.htm">投资券</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/tiyanjin">体验金<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/account">个人信息</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/invite">邀请有奖</a></h3></li>		</ul>
	</div>
</div>
			</div>			
		</div>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/user/coupon?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/user/coupon?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
