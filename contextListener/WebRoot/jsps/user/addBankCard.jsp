	...
	<div class="topbar-inner clearfix">
		<div class="alignleft tapbar-social">
			...
			<div class="account_info" id="weixin_account_info">
				扫一扫关注懒投资微信
				<img src="https://s1.lantouzi.com/img/ltz/qrcode.png" width="150px" height="150px" title="微信号:lantouzicom" />
				<p>微信号：lantouzicom</p>
			</div>
		</div>
		<div class="alignright">
			<p class="top-nav clearfix">
									<a href="https://lantouzi.com/user" rel="nofollow">欢迎，jianglk</a>
			...
			<div class="clearfix">
				<div class="alignleft bindcard-show">
					<!-- 已绑定卡的情况 -->
						...
						<!-- 未绑定卡的情况 -->
						<a class="bank-card-blank" href="https://lantouzi.com/user/account/bindcard/bind" target="_blank">
...
(function(){
	...
	<div class="my-nav">
		<ul class="my-nav-1stlevel-list">
			<li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user">账户概览</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/order/datalist">投资记录</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/lingqianjihua">零钱计划<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/trade/datalist">资金流水</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/recharge">我要充值</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/withdraw">我要提现</a></h3></li><li class="my-nav-1stlevel on"><h3><a href="https://lantouzi.com/user/account/bindcard">提现银行卡</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/autobid">自动投标</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/coupon?type=1">投资券</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/tiyanjin">体验金<i>Beta</i></a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/account">个人信息</a></h3></li><li class="my-nav-1stlevel"><h3><a href="https://lantouzi.com/user/invite">邀请有奖</a></h3></li>		</ul>
	</div>
</div>
			</div>			
		</div>
	...
	<div class="clearfix ft-links">
		...
		<div class="wx_qrcode">
			<img src="https://s1.lantouzi.com/img/ltz/qrcode.png" width="120px" height="120px" title="微信号:lantouzicom"/>
		</div>
	</div>
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
