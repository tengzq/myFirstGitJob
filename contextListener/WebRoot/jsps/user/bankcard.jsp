...
<link type="text/css" href="css/p2p.css" rel="stylesheet" />
<link type="text/css" href="css/ui-lightness/jquery-ui-1.8.13.custom.css" rel="stylesheet" />
<script type="text/javascript" src="/member/bha/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="/member/bha/js/jquery-ui-1.8.13.min.js"></script>
<script type="text/javascript" src="/member/bha/js/bha.js"></script>
<link type="text/css" href="/member/css/jquery.areaopt.css" rel="stylesheet" />
<link type="text/css" href="/member/bha/css/jquery.bankcombobox.css" rel="stylesheet" />
<script type="text/javascript" src="/member/bha/js/jquery.bankcombobox.js"></script>
<script type="text/javascript" src="/member/bha/js/jquery.areaopt.js"></script>
<script type="text/javascript" src="/member/js/areaopt.data.js"></script>
<script type="text/javascript" src="/member/bha/js/bha.js"></script>
...
<div class="layout infoWrap">
  <div class="innerInfo regIn pb20 mt20">
    ...
    <div class="layout formWrap">
      <form id="form" action="/member/bha/bindBankCardInfo" method="post" class="reg">
    ...
    <option value="NXS">农村商业银行合集</option>
        ...
        <div class="mt10">
          <label><span class="sign">银行卡种：</span>
          	借记卡
            <input id="cardType" name="memberFastAuthInfoParam.cardType" type="hidden"  value="DEBITCARD"/> 
          </label>
        </div>
        <div class="mt10">
        		 ...
        		 <label><span class="sign">银行卡号：</span>
		            <input id="cardNo" name="memberFastAuthInfoParam.cardNo" type="text"  /><span id="cardNoSpan" class="ml10 prm"></span>
		          </label>
        ...
        <div class="mt10">
          <label><span class="sign">省市信息：</span>
          	<input id="region" type="text" class="TextInput" name="region" readonly="readonly"/><span id="regionSpan" class="ml10 prm"></span>
       ...
       <div class="mt10">
          <ul class="fix">
			<li><label ><span class="sign">支行信息：</span></label>
				 	<input id="bankBranch" name="bankBranch" class="input_text" /><span id="bankBranchSpan" class="ml10 prm"></span>
        			<div style="display: none;">
        			<tr>
    <td class="tdLabel"></td>
    <td
	 ...
	 如不能提供或提供了不准确的信息可能产生到账延时或被银行退回</div>
        ...
        <div class="mt10">
         <label><span class="sign">开户名：</span>
           <input id="userName" name="memberFastAuthInfoParam.userName" type="text"  value="蒋丽坤" readonly/>
         </label>
        </div>
         <div class="mt10">
        ...
        <div class="mt10">
         <label><span class="sign">身份证：</span>
           <input id="identityNo" name="memberFastAuthInfoParam.identityNo" type="text"  value="37052319880831032x"  readonly/>
         </label>
        </div>
        <div class="btnGroup"><a id="acceptBtn" href="#" class="redBtn"><em></em>提交</a></div>
      </form>
    </div>
    <!--表单结束--> 
  </div>
