...
<!-- saved from url=(0030)https://lantouzi.com/about/law -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432022797000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
	...
	<div class="my-mod my-about">
		...
		<div class="bd about-law">
			<p>2014年懒投资平台聘用了奋迅律师事务所为常年法律顾问，并且由奋迅律师事务所为懒投资平台起草各类法律文书，包括各类协议、合同等，以确保与投资人相关的各类文书合法有效。</p>

			<h3>奋迅律师事务所概况</h3>
			<img src="../../jingtai/img/fenxun.png" style="float:right;margin-left:30px;">
			<p>奋迅律师事务所是一家由一批具有多年海外工作背景和丰富中国从业经验的律师创立的中国律师事务所。</p>
			<p>事务所既有擅长给国有、民营企业、中资机构提供法律服务、擅长和监管部门进行协调沟通的律师，也有曾在国际律所多年执业的资深律师。</p>
			<p>其中，有常年法律服务及资本市场经验的王英哲律师和顾问温建利律师，主要为懒投资提供服务与帮助。</p>

			<h3>关于懒投资供居间服务的法律基础及互联网个人借贷合同的合法性，请参阅下文：</h3>
			<p class="q" style="margin-top:0">关于投资人及借款人双方民间借贷关系的合法性</p>
			<p>根据《合同法》第196条规定“借款合同是借款人向贷款人借款，到期返还借款并支付利息的合同”,《合同法》允许自然人等普通民事主体之间发生借贷关系，并允许出借方到期可以收回本金和符合法律规定的利息。</p>
			<p class="q">关于懒投资平台提供居间撮合服务的合法性</p>
			<p>根据《合同法》第23章关于“居间合同”的规定，特别是第424条规定的“居间合同是居间人向委托人报告订立合同的机会或者提供订立合同的媒介服务，委托支付报酬的合同”，懒投资平台作为合法设立的中介服务机构，为民间借贷提供撮合，使借贷双方形成借贷关系并收取相关报酬的居间服务有著明确的法律基础。</p>
			<p class="q">关于电子合同的合法性</p>
			<p>根据《合同法》和《电子签名法》的规定，当事人可以采用合同书、信件和数据电文（包括电报、电传、传真、电子数据交换和电子邮件）等形式订立合同，并通过电子形式所含、所附用于识别签名人身份并表明签名人认可其中内容的数据电文等电子签名方式进行签署，当事人不能仅因合同采用电子签名、数据电文的形式就 否定其法律效力。</p>
			<p class="q">关于投资人通过懒投资平台获得的出借理财收益的合法性</p>
			<p>根据最高人民法院《关于人民法院审理借贷案件的若干意见》第6条：“民间借贷的利率可以适当高于银行的利率，各地人民法院可以根据本地区的实际情况具体掌握，但最高不得超过银行同类贷款利率的四倍（包含利率本数）。超出此限度的，超出部分的利息不予保护。”懒投资平台的出借理财收益未超过银行同类贷款利率的四倍，为合法利息收益，受到法律保护。</p>
		</div>
	</div>
</div>				</div>
	...
	<div class="about-nav" style="margin-top:0;">
		<ul>
			...
			<a href="https://lantouzi.com/about/security">用户保障</a>
			</h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/security">安全保障</a>
			</li><li class="about-nav-2ndlevel on">
			<a href="../../jingtai/css/法律保障.htm">法律保障</a>
	...
	<div class="clearfix ft-links">
		...
		<div class="alignleft ft-links-item protocol">
			...
			<ul class="bd">
				...
				<li>
					<a href="../../jingtai/css/法律保障.htm" rel="nofollow">法律保障</a>
				</li>
				<li>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/about/law?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/about/law?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
