...
<!-- saved from url=(0032)https://lantouzi.com/about/baoli -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432022869000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
		...
		<div class="bd">
			<div class="security_youxuan">
				<div class="security_youxuan_cont">	 
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_01.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_02.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_03.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_04.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_05.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_06.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_07.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/css/ct1_baoli_08.png">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="about-nav" style="margin-top:0;">
		<ul>
			<li class="about-nav-1stlevel"><h3><a href="https://lantouzi.com/about/index">关于懒投资</a></h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/index">公司介绍</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/team">团队介绍</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/contact">联系我们</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/joinus">加入我们</a></li></ul></li><li class="about-nav-1stlevel"><h3><a href="https://lantouzi.com/about/security">用户保障</a></h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/security">安全保障</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/law">法律保障</a></li></ul></li><li class="about-nav-1stlevel"><h3><a href="https://lantouzi.com/about/agreement">相关协议</a></h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/agreement">服务协议</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/privacy">隐私条款</a></li></ul></li><li class="about-nav-1stlevel on"><h3><a href="https://lantouzi.com/about/help">帮助中心</a></h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/help">常见问题</a></li><li class="about-nav-2ndlevel on"><a href="../../jingtai/css/保理业务介绍.htm">保理业务介绍</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/qufenqi">分期债权介绍</a></li><li class="about-nav-2ndlevel"><a href="https://lantouzi.com/about/repayment_ways">还款方式介绍</a></li></ul></li>		</ul>
	</div>
</div>
			</div>
		</div>
	...
	<div class="clearfix ft-links">
		...
		<div class="alignleft ft-links-item help">
			...
			<ul class="bd">
				...
				<li>
					<a href="../../jingtai/css/保理业务介绍.htm" rel="nofollow">保理业务介绍</a>
				</li>
				<li>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/about/baoli?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/about/baoli?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
