...
<!-- saved from url=(0035)https://lantouzi.com/about/security -->
<html><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
<title>懒人投资理财安全保障 - 懒投资</title>
<meta name="keywords" content="懒人投资">
<base href="<%=basePath%>">
<meta name="description" content="懒人投资理财安全保障，全部资金第三方托管，平台无权客户资金，投资成功直接进入借款人账户，保障资金的安全.">
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432022788000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
		...
		<div class="nav">
			<ul class="clearfix">
				...
				<li class="on">
					<a href="../../jingtai/css/懒人投资理财安全保障 - 懒投资.htm">安全保障</a>
				</li>
		...
		<div id="bd">
			<div class="content clearfix">
				<div class="main alignright">
					<div class="my-page my-page-xxx">
	<div class="my-mod my-xxx">
		<div class="hd">
			<h2 style="color:#f66; font-weight:bold; position:absolute; left:240px; padding:0 8px;">提供最全面的安全保障</h2>
		</div>
		<div class="bd">
			<div class="security_four">
			<ul>
				  <li style="background-position:0 0">优选项目更放心</li>
				  <li style="background-position:0 -140px">投资回款更省心</li>
				  <li style="background-position:0 -70px">资金托管更安心</li>
				  <li style="background-position:0 -210px">网站安全更用心</li>
			</ul>
			</div>
			
			<div class="security_youxuan">
				 <div class="security_youxuan_title"><p>优选项目更放心</p></div>
				 <div class="security_youxuan_cont"><img class="security_youxuan_img" src="../../jingtai/images/security_img_1.jpg"></div>
			</div>
			
			<div class="security_youxuan">
				 <div class="security_youxuan_title"><p>资金托管更安心</p></div>
				 <div class="security_youxuan_cont">
				 <img class="security_youxuan_img" src="../../jingtai/images/security_img_2.jpg">
				 <p class="security_youxuan_text sub_text">第三方资金托管，意味着投资平台不直接经手客户资金，也无权擅自动用客户在第三方托管的资金，投资人通过第三方支付投资成功后，资金将直接进入借款人账户，保证交易真实和投资人资金安全。</p>
				 </div>
			</div>
			
			 <div class="security_youxuan">
				 <div class="security_youxuan_title"><p>投资回款更省心</p></div>
				 <div class="security_youxuan_cont">
					 <img src="../../jingtai/images/security_img_3.jpg" style="float:left; padding:40px 30px; display:inline;">
					 <div class="security_huikuan_text">
						<p style="background:url(https://s1.lantouzi.com/img/ltz/aboutus_sprite.png) no-repeat 0 -280px; padding-left:24px; color:#999; line-height:20px;">借款人到期未还款怎么办？</p>
						<p style="font-size:18px; font-weight:bold; color:#f66; line-height:44px;">三重保障</p>
						<p>合作机构代偿<br>启动风险保障金代偿<br>经过法律途径解决违约问题</p>
					 </div>
			...
			<div class="security_youxuan">
				 <div class="security_youxuan_title"><p>网站安全更用心</p></div>
				 <div class="security_youxuan_cont"><img class="security_youxuan_img" src="../../jingtai/images/security_img_4.jpg"></div>
			</div>
		</div>
	</div>
</div>				</div>
	...
	<div class="about-nav" style="margin-top:0;">
		<ul>
			<li class="about-nav-1stlevel"><h3>
			<a href="https://lantouzi.com/about/index">关于懒投资</a>
			</h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/index">公司介绍</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/team">团队介绍</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/contact">联系我们</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/joinus">加入我们</a>
			</li></ul></li><li class="about-nav-1stlevel on"><h3>
			<a href="../../jingtai/css/懒人投资理财安全保障 - 懒投资.htm">用户保障</a>
			</h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel on">
			<a href="../../jingtai/css/懒人投资理财安全保障 - 懒投资.htm">安全保障</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/law">法律保障</a>
			</li></ul></li><li class="about-nav-1stlevel"><h3>
			<a href="https://lantouzi.com/about/agreement">相关协议</a>
			</h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/agreement">服务协议</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/privacy">隐私条款</a>
			</li></ul></li><li class="about-nav-1stlevel"><h3>
			<a href="https://lantouzi.com/about/help">帮助中心</a>
			</h3><ul class="about-nav-2ndlevel-list"><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/help">常见问题</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/baoli">保理业务介绍</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/qufenqi">分期债权介绍</a>
			</li><li class="about-nav-2ndlevel">
			<a href="https://lantouzi.com/about/repayment_ways">还款方式介绍</a>
			</li></ul></li>		</ul>
	</div>
</div>
			</div>
	...
	<div class="clearfix ft-links">
		...
		<div class="alignleft ft-links-item protocol">
			...
			<ul class="bd">
				<li>
					<a href="../../jingtai/css/懒人投资理财安全保障 - 懒投资.htm" rel="nofollow">安全保障</a>
				</li>
				<li>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/about/security?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/about/security?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
