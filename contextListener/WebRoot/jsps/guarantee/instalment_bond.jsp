...
<!-- saved from url=(0034)https://lantouzi.com/about/qufenqi -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432022887000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
		...
		<div class="bd">
			<div class="security_youxuan">
				<div class="security_youxuan_cont">	 
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_01.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_02.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_03.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_04.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_05.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_06.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_07.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_08.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_09.png">
					<img class="security_youxuan_img" style="width:100%" src="../../jingtai/img/ct_fenqi_10.png">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="about-nav" style="margin-top:0;">
		<ul>
			...
			<a href="../../jingtai/css/分期债权介绍.htm">分期债权介绍</a>
			</li><li class="about-nav-2ndlevel">
	...
	<div class="clearfix ft-links">
		...
		<div class="alignleft ft-links-item help">
			...
			<ul class="bd">
				...
				<li>
					<a href="../../jingtai/css/分期债权介绍.htm" rel="nofollow">分期债权介绍</a>
				</li>
				<li>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/about/qufenqi?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/about/qufenqi?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
