...
<!-- saved from url=(0034)https://lantouzi.com/about/contact -->
...
(function(){
	window.CONFIG = {"PASSPORT_API_HOST":"https:\/\/u.dawanjia.com.cn\/user\/api\/","CAPTCHA_HOST":"https:\/\/u.dawanjia.com.cn\/captcha","ENCRYPT_TIMEOUT":120000,"SERVER_TIME":1432022639000};
...
<!-- 			<a href="https://lantouzi.com/zt/festival" target="_blank" style="display:block;position: absolute;right: 0;top: 0;width:170px;height:65px;z-index:100"></a>
	...
	<div class="my-mod my-about">
		<div class="hd">
			<h2 style="color:#f63; font-weight:bold;">联系我们</h2>
		</div>
		<div class="bd">
			<div class="contact_title" style="background-position:0 -351px;">
				<p>客户服务</p>
			</div> 
			<div class="contact_text">
				<p>联系电话：400-807-8000  （工作日 9:00-22:00）</p>
				<p>客服邮箱：<a href="mailto:kefu@lantouzi.com">kefu@lantouzi.com</a></p>
			</div>
			<div class="contact_title" style="background-position:0 -375px;">
				<p>商业合作</p>
			</div> 
			<div class="contact_text">
				<p>我要合作：<a href="mailto:bd@lantouzi.com">bd@lantouzi.com</a></p>
			</div>

			<div class="contact_title" style="background-position:3px -327px;">
				<p>北京大家玩科技有限公司地址</p>
			</div>
			<a target="_blank" href="http://map.baidu.com/?newmap=1&ie=utf-8&s=s%26wd%3D%E4%B8%89%E9%87%8C%E5%B1%AFSOHO%20%E5%8A%9E%E5%85%ACa"><img style=" display:block;border:solid 1px #ccc; margin:10px auto;" src="../../jingtai/css/contact_img.jpg"></a>
			<div class="contact_text">
				<p>公司地址：北京市朝阳区三里屯SOHO&nbsp;&nbsp;A座1701室</p>
				<p>交&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;通：地铁10号线 团结湖站D口出；</p>
				<p style="line-height:18px; padding-left:70px;">公交三里屯站&nbsp;113路; 115路; 416路环行; 417路; 431路; 701路; 特16路</p>
			</div>			
		</div>
	</div>
</div>				</div>
	...
	<div class="about-nav" style="margin-top:0;">
		<ul>
			<li class="about-nav-1stlevel on"><h3>
			...
			<a href="../../jingtai/css/联系我们.htm">联系我们</a>
			</li><li class="about-nav-2ndlevel">
	...
	<div class="clearfix ft-links">
		<div class="alignleft ft-links-item about">
			...
			<ul class="bd">
				...
				<li>
					<a href="../../jingtai/css/联系我们.htm" rel="nofollow">联系我们</a>
				</li>
				<li>
	...
	<div class="clearfix ft-bottom">
		...
		<div class="alignright copyright">
			...
			<p><a href="https://lantouzi.com/about/contact?ua=pc" style="color:#999;padding:0px 5px;" rel="nofollow">PC版</a>
			<a href="https://lantouzi.com/about/contact?ua=mobile" style="color:#999;padding:0px 5px;text-decoration:underline" rel="nofollow">手机版</a></p>
		</div>
	</div>
	</div>
