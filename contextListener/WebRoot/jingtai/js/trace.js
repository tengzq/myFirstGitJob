	...
	window.zz_trace={
			...
			syncTrans:function(callback){
				if(typeof(callback)=="function"){
					...
					if(typeof(_zzsiteid)!=="undefined"&&typeof(_zzid)!=="undefined") {
						img.src=this.protocol+'trace.zhiziyun.com/o.do?siteid=' + _zzsiteid + '&zzid=' + _zzid  + '&ordercode=' + encodeURIComponent(this.zztrans.transId+"_"+this.zztrans.transExt) + '&amt=1&orderdetail=' +encodeURIComponent(this.zztrans.transExt) + ':1:1&roid=' + Math.random();
					}
				}
				else{
					if(typeof(_zzsiteid)!=="undefined"&&typeof(_zzid)!=="undefined") {
						var an_orsrc = this.protocol+'trace.zhiziyun.com/o.do?siteid=' + _zzsiteid + '&zzid=' + _zzid  + '&ordercode=' + encodeURIComponent(this.zztrans.transId+"_"+this.zztrans.transExt) + '&amt=1&orderdetail=' +encodeURIComponent(this.zztrans.transExt) + ':1:1&roid=' + Math.random();
						this.process(an_orsrc,true);
					}
				}
			},
