	...
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX }/user/list.do" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>用户名：<input type="text" class="checkReset" name="name" value="${user.name }" /></td>
				</tr> 
			</table>
			<div class="subBar">
				<ul>
...
<div class="pageContent">
	...
	<table class="table" width="1200" layoutH="138">
		<thead>
			<tr>
				<th width="40">序号</th>
				<th orderfield="name" class="<c:if test="${order.field eq 'name'}">${order.direction }</c:if>">用户名</th>
			</tr>
		</thead>
		<tbody>
